...
namespace RegisterApp.Controllers
{
    public class RegistersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Firstname,Lastname,Address,Email")] Register register)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Firstname,Lastname,Address,Email")] Register register)
        {
            if (id != register.ID)
            {
                return NotFound();
